...
#
# RK3128 load addresses match mainline U-Boot rk3128_common.h

setenv ramdisk_addr_r "0x64000000"
setenv kernel_addr_r "0x62000000"
setenv fdt_addr_r "0x61f00000"
...
setenv earlycon "off"
setenv fdtfile "rockchip/rk3128-box.dtb"
setenv overlay_prefix "rk3128"
...
if test "${earlycon}" = "on"; then setenv consoleargs "earlycon=uart8250,mmio32,0x20068000 ${consoleargs}"; fi
